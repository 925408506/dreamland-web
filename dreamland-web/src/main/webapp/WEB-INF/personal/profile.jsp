        ...
        <div id="base_content" style="margin-top: 40px;margin-left: 60px;font-size: 18px;" >
            ...
            <div>
                <form id="userInfo_form" action="${ctx}/saveUserInfo" method="post">
                    ...
                    生日： <input  style="width: 198px;float: right;margin-right: 484px;margin-top: -4px" class="form-control form-date"  readonly="readonly" placeholder="选择一个日期：yyyy-MM-dd" type="text" id="txtEndDate"  name="birthday" value="${userInfo.getFormatDate()==null?"":userInfo.getFormatDate()}"/><br/><br/>
            ...
            <div>
                ...
                账号：${user.email}<br/><br/>
                    ...
                    <c:if test="${not empty user.phone}">
                        手机号：${user.phone.substring(0,3)}****${user.phone.substring(7,11)}  <a href="${ctx}/rephone"><span id="phone_span" style="color: grey;margin-left: 68px" onmouseover="changeColor(this);" onmouseout="backColor(this);">修改</span></a>
                    </c:if>
                    <c:if test="${empty user.phone}">
                    手机号：  <a href="${ctx}/rephone"><span id="phone_span" style="color: grey;margin-left: 180px" onmouseover="changeColor(this);" onmouseout="backColor(this);">修改</span></a>
                    </c:if>
                </form>
            </div>
        </div>
