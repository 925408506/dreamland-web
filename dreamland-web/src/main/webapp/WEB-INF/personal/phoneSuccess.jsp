        ...
        <div style="text-align: center">
            ...
            <div style="float: left;margin-top: 40px;margin-left: 50px;">
                <c:if test="${message eq 'success'}">
                    ...
                    <button onclick="relogin();" style="background-color: #5CACEE;height: 30px;width: 80px;margin-left: 140px;margin-top: 50px"  class="btn btn-block " type="button"><span style="color: #EBEBEB">返回</span></button>
                </c:if>
